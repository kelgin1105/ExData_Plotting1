...
par(mfrow = c(2,2))
plot(data_Feb$Date_Time, data_Feb$Global_active_power, type = "l", 
     xlab = "", ylab = "Global Active Power")

plot(data_Feb$Date_Time, data_Feb$Voltage, type = "l", 
...
plot(data_Feb$Date_Time, data_Feb$Global_reactive_power, type = "l", 
